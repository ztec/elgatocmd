...
// Package hidraw provides a clear runtime error on platforms where Linux
// hidraw is unavailable. Cross-platform binaries still expose help, version,
// authentication metadata, and setup guidance.
package hidraw
